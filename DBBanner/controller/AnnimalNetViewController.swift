...
class AnnimalNetViewController: UIViewController {
...
//        banner.configs.isAutoPlay = true
...
extension AnnimalNetViewController: DBBannerDelegate,DBBannerDataSource{
...
//        cell.imageView.image = UIImage(named: model.icon)
        ...
        cell.imageView.kf.setImage(with: url, placeholder: nil, options:  [.transition(.fade(1))], progressBlock: { (receivedSize, totalSize) in
    ...
    public func dbBanner(_ banner: DBBannerStyle,layoutconfigs: DBBannerLayoutConfigs)->DBBannerLayoutConfigs {
        layoutconfigs.layoutProtocol = DDBannerFlowAnimationLayout()
