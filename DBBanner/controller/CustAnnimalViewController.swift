//
//  CustAnnimalViewController.swift
//  DBBanner
//
...
class CustAnnimalViewController: UIViewController {
...
extension CustAnnimalViewController: DBBannerDelegate,DBBannerDataSource{
    ...
    public func dbBanner(_ banner: DBBannerStyle,layoutconfigs: DBBannerLayoutConfigs)->DBBannerLayoutConfigs {
        layoutconfigs.layoutProtocol = CustomAnimation1()
